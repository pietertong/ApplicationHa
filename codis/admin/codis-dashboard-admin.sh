...
CODIS_PRODUCT_NAME='codis_safe'
CODIS_BIN_DIR=$CODIS_ADMIN_DIR/../bin
CODIS_LOG_DIR=$CODIS_ADMIN_DIR/../log
CODIS_CONF_DIR=$CODIS_ADMIN_DIR/../config/codis
...
restart)
    ...
    ;;
remove-lock)
    $CODIS_ADMIN_TOOL_BIN -v --remove-lock --product="${CODIS_PRODUCT_NAME}" --zookeeper=0.0.0.0:2181
    ;;
*)
